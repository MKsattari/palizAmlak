...
namespace amlak.DataAccess.Adapters.Base
{
	...
	public abstract class DataAccessObject
	{
		...
		/// </summary>
		DatabaseAccessObjectFactory m_DataObjectFactory;
		...
		protected abstract DatabaseAccessObjectFactory CreateDataObjectFactory();
		...
		protected virtual int LoadFromCommand(DataSet dataSetFill, IDbCommand fillCommand)
		{
		...
		protected virtual void AddInsertCommandParameters(IDbCommand insertCommand)
		{
		}
		...
		protected virtual void AddUpdateCommandParameters(IDbCommand updateCommand)
		{
		}
		...
		protected virtual void AddDeleteCommandParameters(IDbCommand deleteCommand)
		{
		}
		...
		public bool UseConnectionAndTransaction(DatabaseConnection dbConnection)
		{
		...
		public virtual int Update(DataSet dataSetUpdate)
		{
			return 0;
		}
